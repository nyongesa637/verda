...
participation in the Verda project a harassment-free experience for
...
welcoming, diverse, inclusive, and healthy community. Because this
project serves human-rights defenders, we hold ourselves to a higher
standard than the typical OSS project: behaviour that is *legal* but
*degrading* is still not welcome here.
...
- Focusing on what is best not just for us as individuals, but for the
  overall community — especially the defenders this project serves
...
- **Doxxing or surveilling a contributor** who appears to be operating
  from an at-risk jurisdiction. This is treated as the most serious
...
repository, issues, PRs, discussions, Discord/Matrix if/when added —
...
address in [`SECURITY.md`](./SECURITY.md) (use the same private channel
...
**Consequence:** A private, written warning from a maintainer,
...
classes of individuals. Doxxing of an at-risk contributor goes
directly to this tier.
